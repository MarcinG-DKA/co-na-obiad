...
| 3 | Freshness + quality floor | Close remaining freshness gaps; lock CI lint/test/build as the floor; fill cookbook §6 | #6 + cross-cutting | unit (gap-fill) + gates | change opened | testing-freshness-quality-floor |
